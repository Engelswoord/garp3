...
class Garp_Spawn_Php_Model_Base extends Garp_Spawn_Php_Model_Abstract {
    ...
    protected $_behaviorsThatRequireParams = ['Weighable'];
    ...
    public function render() {
        ...
        $out = $this->_rl("<?php");
        $out .= $this->_rl('/* This file was generated by ' . self::class . ' - do not edit */');
        ...
        /* Unilingual model */
        if ($model::class === 'Garp_Spawn_Model_I18n') {
            $coreModelId = substr((string) $model->id, 0, -4);
