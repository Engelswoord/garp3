[![Build Status](https://travis-ci.com/engelswoord/garp3.svg?branch=master)](https://travis-ci.com/engelswoord/garp3)
...
```bash
composer create-project engelswoord/garp3-scaffold <your-target-directory>
```

See the Garp3 scaffold readme for more information on building assets and such.

[Check out our wonderful wiki](https://github.com/engelswoord/garp3/wiki) for answers to all
